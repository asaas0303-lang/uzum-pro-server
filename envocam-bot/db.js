...
function upsertCustomer({ chatId, firstName, lastName, username, businessConnectionId, language, lastModelName }) {
  const db = readDb();
  ...
  db.customers[id] = {
    ...
    language: language || existing.language || 'uz',
    lastModelName: lastModelName || existing.lastModelName || null,
